...
document.querySelector(".form").addEventListener("submit", (event)=>{
    ...
    const delay1 = Number(formData.get("delay"));
    const step = Number(formData.get("step"));
    const amount = Number(formData.get("amount"));
    for(let i = 1; i <= amount; i++){
        const currentDelay = delay1 + step * (i - 1);
...
},{"notiflix/dist/notiflix-3.2.6.min.css":"1IPtg","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1IPtg":[function() {},{}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
