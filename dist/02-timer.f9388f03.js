...
const options = {
    ...
    onClose (selectedDates) {
        ...
        if (selectedDate <= new Date()) (0, _notiflixDefault.default).Notify.failure("Please choose a date in the future");
        else document.querySelector("[data-start]").disabled = false;
    }
};
...
function startCountdown() {
    const selectedDate = (0, _flatpickrDefault.default)("#datetime-picker").selectedDates[0];
    ...
    intervalId = setInterval(()=>{
        ...
        if (remainingMs <= 0) {
            ...
            (0, _notiflixDefault.default).Notify.success("The countdown has ended!");
        } else updateTimerDisplay(convertMs(remainingMs));
    }, 1000);
}
document.querySelector("[data-start]").addEventListener("click", startCountdown);

},{"flatpickr":"llQu5","flatpickr/dist/flatpickr.min.css":"eVN6V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc","notiflix/dist/notiflix-3.2.6.min.css":"1IPtg"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"1IPtg":[function() {},{}]},["8lKsl","1AWyZ"], "1AWyZ", "parcelRequire4c75")
